...
export default function Reviews() {
  const { t } = useI18n();
  return (
    <section className="relative w-full bg-bone-100 text-ink py-20 lg:py-28 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-10 mb-12 items-end">
          ...
          <div className="lg:col-span-4 lg:col-start-9">
            <div className="flex items-baseline gap-3 reveal" data-delay="200">
              <div className="font-display text-[28px] font-medium leading-none">5.0</div>
